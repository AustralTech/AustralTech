    ...
    <div className="py-14">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16">
          {postData.map((item) => (
            <article key={item.id} className="group flex flex-col justify-between bg-white border border-gray-300 rounded-lg hover:border-blue transition-transform transform hover:scale-105 duration-500">
              <a href="">
